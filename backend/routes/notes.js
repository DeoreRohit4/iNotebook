...
router.post(
  ...
  [
    ...
    body(
      "description",
      "Description must be atleast of 5 characters or special-characters "
    ).isLength({ min: 5 }),
  ],
  async (req, res) => {
    try {
...
//Route 3: Update and existing note using :PUT "api/notes/updatenote". Login require
router.put("/updatenote/:id", fetchuser, async (req, res) => {
  ...
  try {
    ...
    // Fiinn the note to be updated and update it
